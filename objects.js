...
// console.log("Hoi! Ik ben " + meMyselfAndI.name + " , ik ben " + meMyselfAndI.Age + " jaar oud.")
...
const productDescrition = "De " + product.productName + " is gemaakt van " + product.material[0] + " en " + product.material[1]

console.log(productDescrition);
